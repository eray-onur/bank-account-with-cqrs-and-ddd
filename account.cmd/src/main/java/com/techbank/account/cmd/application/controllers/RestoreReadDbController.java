...
import com.techbank.account.cmd.application.commands.RestoreReadDbCommand;
import com.techbank.account.cmd.application.dto.OpenAccountResponse;
...
public class RestoreReadDbController {
    ...
    public ResponseEntity<BaseResponse> restoreReadDb() {
        try {
            ...
            return new ResponseEntity<>(new BaseResponse("DB restoration is successful!"), HttpStatus.CREATED);
